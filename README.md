...
|                                                       메인페이지                                                       |                                                           ㅇ                                                           |                                                           ㅇ                                                           |                                                           ㅇ                                                           |
| :--------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------: |
| ![mobile](https://github.com/FRONTENDSCHOOL6/1st-ComeOn-TripApp/assets/131448929/7fee6d93-f53f-4a8b-87de-35ac69a2c642) | ![mobile](https://github.com/FRONTENDSCHOOL6/1st-ComeOn-TripApp/assets/131448929/7fee6d93-f53f-4a8b-87de-35ac69a2c642) | ![mobile](https://github.com/FRONTENDSCHOOL6/1st-ComeOn-TripApp/assets/131448929/7fee6d93-f53f-4a8b-87de-35ac69a2c642) | ![mobile](https://github.com/FRONTENDSCHOOL6/1st-ComeOn-TripApp/assets/131448929/7fee6d93-f53f-4a8b-87de-35ac69a2c642) |
...
```
프로젝트를 통해서 혼자서는 경험할 수 없는 여러가지 상황들을 맞이하면서 많이 배울 수 있었고 프로젝트의 규모가 커지면서 컴포넌트 분리와 상태 관리의 중요성을 느낄 수 있는 프로젝트였습니다. 그리고 좋은 팀원들 덕분에 하고 싶었던 여행 테마의 프로젝트를 진행할 수 있었고 모두 다 열심히 해주셔서 좋았습니다.
```
